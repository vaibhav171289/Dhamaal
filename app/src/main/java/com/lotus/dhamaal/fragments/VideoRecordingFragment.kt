...
import com.lotus.dhamaal.utils.AutoFitTextureView
import com.lotus.dhamaal.utils.chooseOptimalSize
import com.lotus.dhamaal.utils.chooseVideoSize
import com.lotus.dhamaal.utils.configureTransform
import java.io.File
...
class VideoRecordingFragment : Fragment() {
    ...
    private fun createVideoFilename():String{
        val timestamp = SimpleDateFormat(FILENAME_FORMAT, Locale.ENGLISH).format(Date())
